...
RIDDLES = {
    ...
    3: [
        {
            "question": "I am light as a feather, yet the strongest person cannot hold me for five minutes. What am I?",
            "answer": "breath",
        },
        {
...
def generate_riddle(difficulty: int, user_id: str | None = None, total_attempts: int = 0) -> dict:
    ...
    return {
        "client_payload": {
            ...
            "difficulty": difficulty,
            "content": {"prompt": riddle["question"]},
        },
...
QUIZZES = {
    ...
    3: [
        ...
        },
        {
            ...
            "options": ["Australia", "South Africa", "New Zealand", "Kenya"],
            "answer": "Australia",
        },
        {
            "question": "How many bones are there in an adult human body?",
            "options": ["206", "205", "210", "300"],
            "answer": "206",
        },
    ],
    4: [
...
def generate_quiz(difficulty: int, user_id: str | None = None, total_attempts: int = 0) -> dict:
    ...
    return {
        "client_payload": {
            "challenge_type": "quiz",
            "difficulty": difficulty,
            "content": {"prompt": quiz["question"], "options": options},
        },
