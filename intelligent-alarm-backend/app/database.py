...
DATABASE_URL = os.getenv(
    "DATABASE_URL", "postgresql://alarm_user:alarm_password@127.0.0.1:5433/alarm_db"
)
...
async def init_redis():
    ...
    try:
        ...
        print(
            f"[WARNING] Redis connection failed: {e}. Falling back to InMemoryBackend for caching."
        )
