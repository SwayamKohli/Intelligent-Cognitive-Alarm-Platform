...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                "BEGINNER", "EASY", "MEDIUM", "HARD", "EXPERT", name="difficultylevel"
            ),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column("is_active", sa.Boolean(), nullable=False, server_default="true"),
        sa.Column(
            "snooze_enabled", sa.Boolean(), nullable=False, server_default="true"
        ),
        sa.Column("snooze_limit", sa.Integer(), nullable=False, server_default="3"),
        sa.Column(
            "active_snooze_count", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column("last_snooze_reset_date", sa.Date(), nullable=True),
        sa.Column(
            "multi_step_requirement", sa.Integer(), nullable=False, server_default="1"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "frequency",
            sa.Enum("DAILY", "WEEKDAYS", "CUSTOM", name="habitfrequency"),
            nullable=False,
